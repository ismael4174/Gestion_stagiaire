...
<div class="sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header">
                ...
                <div>
                    <h4 class="logo-text">Gestion des stagiaires</h4>
                </div>
            ...
            <ul class="metismenu" id="menu">
                ...
                <li class="menu-label">Gestion des stagiaires</li>
                <li>
                    <a href="javascript:;" class="has-arrow">
                        <div class="parent-icon"><i class='lni lni-user'></i>
                        </div>
                        <div class="menu-title">Formateurs</div>
                    </a>
                    <ul>
                        <!-- <li> <a href="{{ url('ajouter-formateur') }}"><i class="bx bx-right-arrow-alt"></i>Ajouter un formateur</a>
                        </li> -->
                        <li> <a href="{{ url('formateur') }}"><i class="bx bx-right-arrow-alt"></i>Voir la liste des formateurs</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        <li> <a href="{{ url('ajouter-stagiaire') }}"><i class="bx bx-right-arrow-alt"></i>Ajouter un stagiaire</a>
                        </li>
                        <li> <a href="{{ url('liste-stagiaire') }}"><i class="bx bx-right-arrow-alt"></i>Voir la liste des stagiaires</a>
                        </li>
                        <li> <a href="{{ url('attribuer-formateur') }}"><i class="bx bx-right-arrow-alt"></i>Attribuer un formateur</a>
                        </li>
                        <li> <a href="{{ url('attribuer-theme') }}"><i class="bx bx-right-arrow-alt"></i>Attribuer un thème de stage</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="javascript:;" class="has-arrow">
                        ...
                        <div class="menu-title">Demandes</div>
                    </a>
                    <ul>
                        
                        <li> <a href="{{ url('liste-demande') }}"><i class="bx bx-right-arrow-alt"></i>Voir la liste des demandes</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="javascript:;" class="has-arrow">
                        ...
                        <div class="menu-title">Postulant</div>
                    </a>
                    <ul>
                        
                        <li> <a href="{{ url('postulant') }}"><i class="bx bx-right-arrow-alt"></i>Voir la liste des postulants</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="javascript:;" class="has-arrow">
                        ...
                        <div class="menu-title">Service d'activité</div>
                    </a>
                    <ul>
                        <li> <a href="{{ url('service') }}"><i class="bx bx-right-arrow-alt"></i>Voir la liste des services</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        <li> <a href="{{ url('session') }}"><i class="bx bx-right-arrow-alt"></i>Voir la liste des sessions</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="javascript:;" class="has-arrow">
                        ...
                        <div class="menu-title">Thèmes stagiaires</div>
                    </a>
                    <ul>
                        <!-- <li> <a href="{{ url('theme/create') }}"><i class="bx bx-right-arrow-alt"></i>Ajouter un thème</a>
                        </li> -->
                        <li> <a href="{{ url('theme') }}"><i class="bx bx-right-arrow-alt"></i>Voir la liste des thèmes</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="javascript:;" class="has-arrow">
                        ...
                        <div class="menu-title">Filières</div>
                    </a>
                    <ul>
                        <li> <a href="{{url('filiere/create')}}"><i class="bx bx-right-arrow-alt"></i>Ajouter une filière</a>
                        </li>
                        <li> <a href="{{ url('filiere') }}"><i class="bx bx-right-arrow-alt"></i>Voir la liste des filières</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="javascript:;" class="has-arrow">
                        ...
                        <div class="menu-title">Types de stage</div>
                    </a>
                    <ul>
                        <li> <a href="{{url('typestage/create')}}"><i class="bx bx-right-arrow-alt"></i>Ajouter un type de stage</a>
                        </li>
                        <li> <a href="{{ url('typestage') }}"><i class="bx bx-right-arrow-alt"></i>Voir la liste des types de stage</a>
                        </li>
                    </ul>
                </li>
