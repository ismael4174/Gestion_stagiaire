...
Route::get('/filiere/{id}/delete', [FiliereController::class, 'destroy']);
// Route::view('/ajouter-filiere', 'ajouter-filiere');
// Route::view('/liste-filiere', 'liste-filiere');
/*Theme*/
Route::resource('/theme', ThemeController::class);
// Route::view('/liste-theme', 'liste-theme');
/*Service d'activité*/
Route::resource('/service', ServiceController::class);
/*Session*/
Route::resource('/session', SessionController::class);
/*Demande*/
Route::view('/liste-demande', 'liste-demande');
/*Postulant*/
Route::resource('/postulant', PostulantController::class);
// Route::view('/liste-postulant', 'liste-postulant');
/*Stagiaire*/
Route::view('/ajouter-stagiaire', 'ajouter-stagiaire');
Route::view('/liste-stagiaire', 'liste-stagiaire');
/*Typestage*/
Route::resource('/typestage', TypestageController::class);
Route::get('/typestage/{id}/delete', [TypestageController::class, 'destroy']);
